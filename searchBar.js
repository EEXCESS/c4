define(['jquery'], function($) {
    var contentArea = $('<iframe src="' + chrome.extension.getURL('external/SearchResultList/index.html') + '" style="position:fixed;width:60%;height:60%;bottom:20px;right:0px;background-color:white;border:1px solid black;z-index:99999"></div>').hide();
